...
return [
    ...
    */
    ...
    'options' => [
        ...
        /**
         * Institution branding settings for PDF exports
         * These settings will be used in PDF templates
         */
        'branding' => [
            'institution_name' => env('INSTITUTION_NAME', 'Learning Management System'),
            'institution_logo' => env('INSTITUTION_LOGO', '/images/logo.png'),
            'institution_address' => env('INSTITUTION_ADDRESS', ''),
            'institution_phone' => env('INSTITUTION_PHONE', ''),
            'institution_email' => env('INSTITUTION_EMAIL', ''),
            'institution_website' => env('INSTITUTION_WEBSITE', ''),
        ],
