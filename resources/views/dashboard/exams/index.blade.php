...
@section('page-title', 'সকল পরীক্ষা')
@section('page-description', 'Manage all exams')
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100">
        ...
        <div class="p-6">
            @if($exams->count() > 0)
                ...
                <x-ui.data-table id="all-exams-table" :headers="$headers" :rows="$exams" :route="route('dashboard.exams.index')">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-500 max-w-sm mx-auto mb-4">Get started by creating your first exam.</p>
