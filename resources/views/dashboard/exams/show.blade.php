                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            <div class="flex items-start justify-between">
                                ...
                                <div class="flex space-x-2 ml-4">
                                    ...
                                    <form action="{{ route('dashboard.exams.questions.destroy', [$exam, $question]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this question?')">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <form action="{{ route('dashboard.exams.delete-result', [$exam, $result]) }}" method="POST" 
                                          onsubmit="return confirm('Are you sure you want to delete this result?')" class="inline">
                                        @csrf
                                        @method('DELETE')
