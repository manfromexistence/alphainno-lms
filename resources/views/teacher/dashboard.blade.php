...
<div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $todaySchedule->count() }}</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        @foreach($todaySchedule as $schedule)
                            <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="ml-4 flex-1">
                                    <p class="text-sm font-medium text-gray-900">{{ $schedule->batch->course->name }}</p>
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
        <a href="{{ route('teacher.attendance') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center">
        ...
        <a href="{{ route('teacher.batches') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center">
        ...
        <a href="{{ route('teacher.schedule') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-900">View Schedule</p>
                </div>
            </div>
        </a>
    </div>
